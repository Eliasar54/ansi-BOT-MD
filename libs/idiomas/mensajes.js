...
//autonivel
const smsAutonivel = () => { return `*「 ¡ENHORABUENA! HAS ALCANZADO UN NUEVO NIVEL 🎀 」*\n\n💖 ¡Qué alegría! Has llegado a un nuevo nivel! 🌸` }
const smsAutonivel2 = () => { return `🌟 ¡Bravo! Has subido de nivel, sigue brillando con tu luz! 💫\n` }
const smsAutonivel3 = () => { return `*🔮 NIVEL ACTUAL:*` }
const smsAutonivel4 = () => { return `*🌼 NIVEL ANTERIOR:*` }
const smsAutonivel5 = () => { return `*🌷 NIVEL NUEVO:*` }
const smsAutonivel6 = () => { return `*✨ RANGO DE MAGIA:*` }
const smsAutonivel7 = () => { return `*🌟 FECHA DEL ASCENSO:*` }
const smsAutonivel8 = () => { return `_*Para conocer tu posición en la lista de las mejores, usa el comando #lb*_` }
const smsAutonivel9 = () => { return `*🎉 ¡FELICIDADES POR ALCANZAR UN NUEVO NIVEL! 🌹*\n\n` }
...
//jadibot.js
const jadibot = {
  text: `🤖 *¡Conviértete en un Bot Temporal Escaneando este QR!* 🤖\n\n
1️⃣ Haz clic en los tres puntos en la esquina superior derecha ⋮\n
2️⃣ Selecciona *WhatsApp Web* 🌐\n
3️⃣ Escanea este QR 📲\n\n
⚠️ *Nota:* El QR expira en 45 segundos, ¡apresúrate! ⏳\n\n`,

  text2: `✨ *NUEVA FORMA DE CONVERTIRTE EN UN SUB BOT* ✨\n\n
1️⃣ Haz clic en los tres puntos en la esquina superior derecha ⋮\n
2️⃣ Selecciona *WhatsApp Web* 🌐\n
3️⃣ Toca en *Vincular con Código de Teléfono* 📱\n
4️⃣ ¡Pega el código que te daremos a continuación! 🔑\n\n
¡Disfruta tu experiencia como sub bot! 🎉🤖`,

  text3: `*⚠️ Este comando fue desabilitado por el creador*`,
  text4: `*✅ Ya estás conectado, sea paciente, los mensajes se están cargando...*`,
  text5: `*Conectado con éxito*`,
  text6: `× Bot :`,
  text7: `× Dueño :`,
  text8: `\`NOTA:\` Esto es temporal. Si el Bot principal se reinicia o se desactiva, todos los sub bots también lo harán.\n\nPuede iniciar sesión sin el código QR con el siguiente mensaje, envíalo cuando no funcione el bot....`,
  text9: `*⚠️ Dispositivo desconectado. Tendrás que volver a conectarte con #jadibot*`,
  text10: `*⚠️ Reenvía el comando....*`,
  text11: `[ ⚠️ ] Reinicio requerido, Reiniciando...`,
  text12: `*⚠️ Dispositivo desconectado*\n\n*Tendrás que volver a iniciar sesión (usa .deljadibot)*`,
  text13: `*⚠️ Conexión cerrada*\n*Intenta reconectarte con:`,
  text14: `[ ⚠️ ] Conexión perdida con el servidor, reconexión Forzada`,
  text15: `*[ ⚠️ ] Tu conexión es inválida*\n*No se te reconectará*`,
  text16: `[ ⚠️ ] Se agotó el tiempo de conexión.`,
  text17: `[ ⚠️ ] Error desconocido:\n`,
...
const smsReg8 = () => { return `*𝙱𝙸𝙴𝙽𝚅𝙴𝙽𝙸𝙳𝙾 𝙰 𝙰𝙽𝚂𝙸𝙱𝙾𝚃 🥰*` }
